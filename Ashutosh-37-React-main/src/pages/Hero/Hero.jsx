...
const profile = {
    ...
    title: 'Frontend Developer | Java DSA Practitioner',
    skills: [
        'ReactJS', 'Redux', 'Tailwind CSS','Figma', 
        'JS Vanilla', 'HTML5', 'JavaScript', 'Java', 
        'Git', 'DSA' , 'VS Code', 'Animations','Intellij IDEA','Cursor.AI'
    ],
    Adapting: true,
    Leader: true,
    TeamPlayer: true,
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/ashutosh936"
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1AvTQVYTDSVPnsB6DuJDbqljJfa7ojrJP/view?usp=sharing"
