...
const EducationSection = () => {
  ...
  const educationData = [
  {
    ...
    school: "Christ Jyoti School",
    mascot: "📘",
    year: "2018 - 2019",
    achievements: ["Percentage: 73.4%", "Board: CBSE Board"],
  ...
  },
  {
    ...
    mascot: "📗",
    year: "2020 - 2021",
    achievements: ["Percentage: 85.6%", "Stream: Physics, Chemistry, Maths"],
  ...
  },
  {
    ...
    mascot: "🎓",
    year: "2022 - Present",
    achievements: ["CGPA: 8.08", "Branch: Information Technology"],
    skills: ["Programming", "Data Structures", "Web Development", "Java"],
    description:
      "Pursuing core computer science subjects with practical exposure in software development and front-end technologies.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-lg">
            Discover  academic excellence shapes innovative thinking and
            professional growth.
          </p>
        </motion.div>
